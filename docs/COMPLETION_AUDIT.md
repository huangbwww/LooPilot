...
Use this only when the machine is stable enough to download/run `cloudflared`. Follow `docs/ACCEPTANCE_RUNBOOK.md` for the final safe, browser, public tunnel, and real bridge acceptance sequence.
