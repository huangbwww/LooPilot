...
Use this only after confirming the target Codex session, because the command sends a real message. Follow `docs/ACCEPTANCE_RUNBOOK.md` for the final safe, browser, public tunnel, and real bridge acceptance sequence.
